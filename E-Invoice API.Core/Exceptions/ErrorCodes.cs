...
namespace E_Invoice_API.Core.Exceptions
{
    public static class ErrorCodes
    {
        ...
        public static string ApplicationWithGivenIdNotFound => "application_with_given_id_not_found";
        public static string ApplicationUserVoteWithGivenIdNotFound => "application_user_votes_with_given_id_not_found";
        public static string ApplicationCommentWithGivenIdNotFound => "application_comment_with_given_id_not_found";
        public static string ForumThreadWithGivenIdNotFound => "forum_thread_with_given_id_not_found";
        public static string ForumCommentWithGivenIdNotFound => "forum_comment_with_given_id_not_found";
        public static string FAQtWithGivenIdNotFound => "faq_with_given_id_not_found";
    }
}
